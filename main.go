...
func init() {
	...
	_ = towerv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "244a632e.ansible.com",
	})
	if err != nil {
	...
	if err = (&controllers.AnsibleJobReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("AnsibleJob"),
